package com.application.material.bookmarkswallet.app.browser;
...
import android.graphics.BitmapFactory;
import android.net.Uri;
import com.application.material.bookmarkswallet.app.browser.BrowserContract.Bookmarks;
import com.application.material.bookmarkswallet.app.browser.BrowserContract.Combined;
import com.application.material.bookmarkswallet.app.browser.BrowserContract.History;
import com.application.material.bookmarkswallet.app.browser.BrowserContract.Searches;
...
public class BrowserCustom {
    ...
    public static final void sendString(Context context, String string) {
        sendString(context, string, context.getString(android.R.string.selectTextMode));
    }
