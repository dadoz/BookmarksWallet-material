...
public class BookmarkRecyclerViewAdapter extends MultipleSelectorHelperAdapter {
     ...
     * @param noFaviconMode
     */
    public BookmarkRecyclerViewAdapter(Context ctx, OnMultipleSelectorCallback lst, boolean noFaviconMode) {
        super(lst, noFaviconMode);
    ...
    public void setIsFaviconIsEnabled(WeakReference<Context> ctx) {
        isFaviconNotEnabled = (boolean) SharedPrefHelper.getInstance(ctx.get()).getValue(NO_FAVICON_MODE, false);
    }
}
