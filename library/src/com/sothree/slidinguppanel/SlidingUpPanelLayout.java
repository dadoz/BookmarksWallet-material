...
//            if (i == 0) {
////                Log.e("LIBRARY", "child height " + childHeight);
//                childHeight = b - t - mPanelHeight - paddingTop - getPaddingBottom();
////                Log.e("LIBRARY", "child height new" + (b - t - mPanelHeight - paddingTop - getPaddingBottom()));
//            }
...
//        Log.e("Library", " - " + computePanelTopPosition(slideOffset));
        ...
        //here there's keyboard problem - computePanelTopPosition is wrong :(
